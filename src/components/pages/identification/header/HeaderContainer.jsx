...
const HeaderContainer = ({ props, changeLanguage, setDisplayMode, isDarkModeEnabled }) => {
  const { t } = props
  return (
    <header className="identifier-app__header relative flex-shrink-0 flex flex-nowrap items-center justify-between max-w-full bg-green-700 p-1 shadow-xl">
      ...
      <section className="w-fit flex items-center pl-1">
        ...
        <Menu as={"menu"} className="inline-block h-10 pl-2">
          ...
          >
            <Menu.Items className={"absolute right-1 mt-2 w-40 p-1 origin-top-right grid grid-flow-row gap-1 items-center rounded-lg bg-green-700 shadow-lg text-base z-10"}>
