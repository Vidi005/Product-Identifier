...
import LargeDeviceDisplayList from "../../list_product_tab/LargeDeviceDisplayList"
import MobileDeviceDisplayList from "../../list_product_tab/MobileDeviceDisplayList"
        ...
        <Dialog as={"section"} className="scan-result-modal relative z-10" onClose={() => onCloseScanResultModal()}>
          ...
          >
            <Dialog.Panel className={"flex flex-col bg-green-100 dark:bg-gray-700 w-full h-full max-w-5xl font-sans p-4 rounded-t-lg shadow-lg dark:shadow-white/50 overflow-hidden"}>
              ...
              <MobileDeviceDisplayList t={props.t} selectedProduct={scannedProduct} />
              <LargeDeviceDisplayList t={props.t} selectedProduct={scannedProduct} />
            </Dialog.Panel>
          </Transition.Child>
        </Dialog>
      </Transition>
