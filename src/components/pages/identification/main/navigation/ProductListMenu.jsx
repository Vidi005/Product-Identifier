...
const ProductListMenu = ({ onClickEditBtn }) => (
  <nav className="content__product-list-menu fixed md:hidden right-2 bottom-2">
    <menu className="menu-item grid grid-cols-2 gap-2 items-center">
      ...
      <span className="add-item w-fit p-2 bg-green-700 active:bg-green-900 rounded-full shadow-md dark:shadow-white/50 cursor-pointer animate__animated animate__fadeInBottomRight" onClick={() => onClickEditBtn(0)}>
