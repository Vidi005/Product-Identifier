...
const LargeDeviceDisplayList = ({ t, index, productName, productIds, category, vendor, origin, dateCreated, nameTag, colorTag, description, alternatives, source, addedBy, modifiedBy, pagePosition, itemsPerPage, i, onClickDetailBtn, onClickEditBtn, onClickDeleteBtn }) => i % 2 === 0
  ? (
