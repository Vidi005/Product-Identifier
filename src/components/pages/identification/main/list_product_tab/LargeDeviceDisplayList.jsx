...
const LargeDeviceDisplayList = ({ t, index, productName, productIds, category, vendor, origin, dateCreated, nameTag, colorTag, description, alternatives, source, i, onClickDetailBtn, onClickEditBtn, onClickDeleteBtn }) => i % 2 === 0
  ? (
    <div className="content__product-item hidden md:flex items-center duration-200 animate__animated animate__fadeInUp leading-normal m-1 pr-3 border border-gray-700 bg-gray-300 dark:border-gray-200 dark:bg-gray-700 rounded-lg shadow dark:shadow-white overflow-hidden">
      ...
      <button className="detail-btn border border-green-700 ml-3 p-1 bg-green-700 duration-200 hover:bg-green-500 rounded-lg shadow dark:shadow-white" onClick={() => onClickDetailBtn(index)}>
  ...
  : (
    <div className="content__product-item hidden md:flex items-center duration-200 animate__animated animate__fadeInUp leading-normal m-1 pr-3 border border-gray-700 bg-white dark:border-gray-200 dark:bg-black rounded-lg shadow dar overflow-hidden">
      <span className="item-content grow text-black dark:text-white">
        <h4 className="px-1 py-0.5">{productName}</h4>
        <p className="px-1 py-0.5">Vendor: {vendor}</p>
        <p className="px-1 py-0.5 text-white rounded-tr-3xl" style={{ backgroundColor: `${colorTag}`}}>{t('name_tag')}: {nameTag}</p>
