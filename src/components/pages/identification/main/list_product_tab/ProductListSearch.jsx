...
class ProductListSearch extends React.Component {
  ...
  render() {
    return (
      <input
        className="grow mr-2 p-1 border border-green-800 dark:border-gray-100 bg-green-50/25 dark:bg-gray-900/25 dark:text-white rounded-lg shadow-inner dark:shadow-white/50 backdrop-blur-sm"
        type="search"
