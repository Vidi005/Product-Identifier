...
const MobileDeviceDisplay = ({ t, index, productName, productIds, category, vendor, origin, dateCreated, nameTag, colorTag, description, alternatives, source, i, onClickDetailBtn, onClickEditBtn, onClickDeleteBtn }) => i % 2 === 0
  ? (
...
export default withTranslation()(MobileDeviceDisplay)